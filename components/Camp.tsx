    ...
    py-10 lg:mb-10 lg:py-20 xl:mb-20'>
      ...
      justify-start gap-8 overflow-x-auto lg:h-[400px] xl:h-[640px]'>
        <CampSite 
          ...
          title='Aleyita Camp'
          subtitle='Abuja Technology Village'
          peopleJoined='100+ Joined'
        />
        <CampSite 
          backgroundImage='bg-bg-img-2'
          title='Ekogi Camp'
          subtitle='Agaie Local Government'
          peopleJoined='100+ Joined'
        />
      </div>
      <div className="flexEnd mt-10 px-6 lg:-mt-60 lg:mr-6">
        <div className="bg-green-50 p-8 lg:max-w-[500px] xl:max-w-[734px] xl:rounded-5xl xl:px-16 xl:py-20 relative w-full overflow-hidden rounded-3xl" >
          ...
          <p className="regular-14 xl:regular-16 mt-5 text-white">
            Starting from the anxiety of climbers when visiting a new climbing location, the possibility of getting lost
            is very high. that's why we are here for those of you who want to start an adventure
          </p>
          <Image 
            src="/qoute.svg"
            alt="camp-2"
